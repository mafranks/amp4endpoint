...
def main():
    ...
    while(1):
        ...
        print("\nWaiting for next scan in {} hours.".format(sleep_time/360))
...
def init_params():
    ...
    if (op == "y"):
        ...
        sleep_time = float(sleep_time) * 360
        global auth_string
        auth_string = "https://{}:{}@api.amp.cisco.com".format(client_id, api_key)
...
def delete_endpoints(duplicates):
    ...
    for guid in duplicates:
        ...
        if response.status_code == 200:
            print("Successfully deleted {}".format(guid))
        else:
            print ("Unable to delete {}, response code: {}".format(guid, response.status_code))
